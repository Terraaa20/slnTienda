    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-section">
                <h2><i class="fas fa-tags"></i>Datos de la Categoría</h2>
                
                <div class="form-group">
                    <label for="txtIdCategoria"><i class="fas fa-key"></i>ID Categoría:</label>
                    <asp:TextBox ID="txtIdCategoria" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                </div>
                
                <div class="form-group">
                    <label for="txtNombre"><i class="fas fa-font"></i>Nombre:</label>
            ...
            <asp:GridView ID="gvCategorias" runat="server" CssClass="grid-view" AutoGenerateColumns="False" 
                OnRowDeleting="gvCategorias_RowDeleting" OnRowEditing="gvCategorias_RowEditing" DataKeyNames="IdCategoria">
                <Columns>
